...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, C(KC_C), C(KC_V), _______, KC_F13,  KC_DEL,  XXXXXXX, KC_UNDS, KC_PLUS, _______,  _______, KC_PIPE, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, C(KC_C), C(KC_V), _______, KC_F13,  _______,  KC_PLUS, KC_MINS, KC_EQL,  _______, _______, KC_BSLS, \
