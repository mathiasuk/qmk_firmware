 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  MT(MOD_LCTL, KC_ESC), MT(MOD_LCTL, KC_A), MT(MOD_LALT, KC_S), MT(MOD_LSFT, KC_D), MT(MOD_LGUI, KC_F), KC_G,                    KC_H,    MT(MOD_RGUI, KC_J),    MT(MOD_RSFT, KC_K),    MT(MOD_RALT, KC_L),    MT(MOD_RCTL, KC_SCLN), MT(MOD_RCTL, KC_QUOT), \
